...
class BingoBoardsStoreModal extends StatelessWidget {
  ...
  final String boardsAmount;

  const BingoBoardsStoreModal({
    super.key,
    required this.onClose,
    required this.boardsAmount,
  });
  ...
  Widget build(BuildContext context) {
    final purchaseOptions = [
      ...
      {'amount': '4', 'price': '20', 'plus': '1'},
      {'amount': '8', 'price': '30', 'plus': '2'},
      {'amount': '12', 'price': '45', 'plus': '4'},
      {'amount': '16', 'price': '60', 'plus': '6'},
      {'amount': '20', 'price': '120', 'plus': '8'},
    ];
